...
public class MvcHeaderController {
    ...
    public record LabelUserParameter(String label, String user) {}
    ...
    @PostMapping("/search")
    public String search(@ModelAttribute("parameter") LabelUserParameter labelUserParameter, Model model) {
