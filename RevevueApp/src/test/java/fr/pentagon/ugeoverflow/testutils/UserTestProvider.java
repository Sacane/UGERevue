...
public class UserTestProvider {
    ...
    @Transactional
    public void addSomeUsersIntoDbWithQuestionVote() throws IOException {
        List<User> users = List.of(
                new User("Sacane", "loginSacane", passwordEncoder.encode("SacanePassword"), "sacane.test@gmail.com", Role.USER),
                new User("Sacane2", "loginSacane2", passwordEncoder.encode("SacanePassword2"), "sacane2.test@gmail.com", Role.USER),
                new User("Sacane3", "loginSacane3", passwordEncoder.encode("SacanePassword3"), "sacane3.test@gmail.com", Role.USER),
        ...
        questionService.vote(user1.getId(),  entity.getId(), true);
        questionService.vote(user2.getId(),  entity.getId(), true);
        questionService.vote(user3.getId(),  entity.getId(), true);

        questionService.vote(user1.getId(),  entity3.getId(), false);
        questionService.vote(user2.getId(),  entity3.getId(), false);
        questionService.vote(user3.getId(),  entity3.getId(), false);

        questionService.vote(user1.getId(),  entity4.getId(), false);
        questionService.vote(user2.getId(),  entity4.getId(), true);
        questionService.vote(user3.getId(),  entity4.getId(), true);
    }
